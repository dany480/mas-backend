...
exports.CreateCourseUnitServicies = void 0;
var typeorm_1 = require("typeorm");
var CourseUnit_1 = require("../models/CourseUnit");
var CreateCourseUnitServicies = /** @class */ (function () {
    function CreateCourseUnitServicies() {
    }
    CreateCourseUnitServicies.prototype.execute = function (data) {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (checkCourseUnitExists) {
                            return [2 /*return*/, { erro: "CourseUnit already exists" }];
                        }
    ...
    return CreateCourseUnitServicies;
}());
exports.CreateCourseUnitServicies = CreateCourseUnitServicies;
